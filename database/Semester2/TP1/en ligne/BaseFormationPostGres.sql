...
-----------------------------------------------------------------------------------
INSERT INTO formateur (nom_formateur, prenom_formateur)
VALUES('Jacques' ,'Mesrine');
...
VALUES(42, 5 ,'2019-01-23', 2, 2, 1, 'Matin','E410');
-----------------------------------------------------------------------------------
UPDATE planifier
SET dateform = dateform + INTERVAL '9 days'
WHERE id_formation IN (SELECT id_formation 
                       FROM formation 
                       WHERE intitule_formation like '%Initiation a Linux%');
