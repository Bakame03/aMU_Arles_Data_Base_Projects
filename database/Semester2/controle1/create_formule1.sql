create schema CTRL1_formule1;
set search_path=CTRL1_formule1;
...
constraint PK_COURIR primary key (idGP, id_Pilote)
);
...
nomSponsor varchar(45)	not null,
id_Pilote integer		not null,
constraint PK_SOUTENIR primary key (nomSponsor, id_Pilote)
);
...
alter table Courir
 add constraint FK_COURIR____PILOTE foreign key (id_Pilote)
...
alter table Ecurie
 add constraint FK_ECURIE_ACCORDER_FOURNISS foreign key (id_Four)
...
alter table soutenir
 add constraint FK_SOUTENIR_SOUTENIR_PILOTE foreign key (id_Pilote)
references Pilote (id_Pilote)
on delete restrict on update restrict;
...
INSERT INTO fournisseur VALUES (1, 'Michelin', 'P.O. Box 461, 2514 Volutpat. St.', 'Gliwice', 63000, '2016-11-22');
INSERT INTO fournisseur VALUES (2, 'Pirelli', '4481 Pellentesque Street', 'Sainte-Ode', 25348, '2017-02-18');
INSERT INTO fournisseur VALUES (3, 'Fireston', 'P.O. Box 815, 2101 Enim Rd.', 'Birori', 55864, '2015-11-15');
...
INSERT INTO grandprix VALUES (1, 1, 'Grand Prix d''Australie', 156, '2016-01-26', 20, 156);
INSERT INTO grandprix VALUES (2, 2, 'Grand Prix des Etats-Unis', 194, '2016-04-24', 18, 194);
INSERT INTO grandprix VALUES (3, 3, 'Grand Prix de Bahreïn', 246, '2016-04-01', 19, 230);
INSERT INTO grandprix VALUES (4, 4, 'Grand Prix d''Espagne', 166, '2017-02-10', 22, 166);
INSERT INTO grandprix VALUES (5, 5, 'Grand Prix du Canada', 210, '2016-12-13', 18, 210);
INSERT INTO grandprix VALUES (6, 6, 'Grand Prix d''Allemagne', 178, '2016-12-01', 20, 178);
INSERT INTO grandprix VALUES (7, 7, 'Grand Prix de Hongrie', 196, '2016-09-11', 18, 196);
INSERT INTO grandprix VALUES (8, 8, 'Grand Prix du Brésil', 124, '2017-01-10', 22, 124);
INSERT INTO grandprix VALUES (9, 9, 'Grand Prix de Monaco', 146, '2017-08-22', 20, 146);
INSERT INTO grandprix VALUES (10, 6, 'Grand Prix d''Italie', 254, '2016-12-07', 19, 254);
INSERT INTO grandprix VALUES (11, 11, 'Grand Prix d''Autriche', 452, '2015-11-09', 21, 350);
INSERT INTO grandprix VALUES (12, 12, 'Grand Prix de Malaisie', 128, '2017-04-06', 21, 128);
INSERT INTO grandprix VALUES (13, 13, 'Grand Prix de Chine', 298, '2015-12-14', 19, 298);
INSERT INTO grandprix VALUES (14, 14, 'Grand Prix de Grande-Bretagne', 300, '2017-06-28', 19, 100);
INSERT INTO grandprix VALUES (15, 15, 'Grand Prix de Singapour', 214, '2016-11-13', 21, 200);
INSERT INTO grandprix VALUES (16, 16, 'Grand Prix de Belgique', 400, '2016-10-03', 21, 400);
INSERT INTO grandprix VALUES (17, 17, 'Grand Prix de Russie', 326, '2017-07-11', 20, 326);
INSERT INTO grandprix VALUES (18, 18, 'Grand Prix du Japon', 426, '2017-02-21', 22, 200);
INSERT INTO grandprix VALUES (19, 19, 'Grand Prix d''Abou Dabi', 264, '2016-07-21', 20, 264);
...
--
-- Name: circuit_id_circuit_seq; Type: SEQUENCE SET; Schema: ctrl1_formule1; Owner: carmigna
--

SELECT pg_catalog.setval('ctrl1_formule1.circuit_id_circuit_seq', 19, true);


--
-- Name: ecurie_id_ecurie_seq; Type: SEQUENCE SET; Schema: ctrl1_formule1; Owner: carmigna
--

SELECT pg_catalog.setval('ctrl1_formule1.ecurie_id_ecurie_seq', 11, true);


--
-- Name: fournisseur_idfour_seq; Type: SEQUENCE SET; Schema: ctrl1_formule1; Owner: carmigna
--

SELECT pg_catalog.setval('ctrl1_formule1.fournisseur_id_four_seq', 1, false);


--
-- Name: grandprix_idgp_seq; Type: SEQUENCE SET; Schema: ctrl1_formule1; Owner: carmigna
--

SELECT pg_catalog.setval('ctrl1_formule1.grandprix_idgp_seq', 19, true);


--
-- Name: pilote_idpilote_seq; Type: SEQUENCE SET; Schema: ctrl1_formule1; Owner: carmigna
--

SELECT pg_catalog.setval('ctrl1_formule1.pilote_id_pilote_seq', 1, false);
